...
CREATE TABLE matches (id TEXT PRIMARY KEY,
                      ...
                      game_rules_id INTEGER NOT NULL REFERENCES game_rules (id),
...
INSERT INTO game_rules (type, balls_per_over, no_ball_penalty, wide_penalty, only_single_batter, allow_last_man, overs_per_innings, overs_per_bowler) VALUES
