...
class ColorStyles {
  ...
  // Balls
  static Color ballFour = Colors.lightBlueAccent;
  static Color ballSix = Colors.deepPurpleAccent;
  static Color wicket = Colors.red;
  static Color ballNoBall = Colors.pink;
  static Color ballWide = Colors.yellowAccent;
